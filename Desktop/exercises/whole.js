...
module.exports = {guesting,sumOfCubes,volumeOfCylinder,
                  determiner,longestString,largestInt,
                  multiplication,division,christMas,comparism,
                  filtered,deleteCharacter,extract,add,
                clock}